...
$app->post('/api/Ghost/getPost', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['clientId','clientSecret','blogUrl','postId']);
    ...
    $url .= $queryParam['postId'];
    unset($queryParam['postId']);
